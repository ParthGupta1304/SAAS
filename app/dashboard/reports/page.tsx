    ...
    <main className="min-h-screen bg-[#070b12] text-zinc-50">
      ...
      <div className="border-b border-white/10 bg-[#070b12]/90 backdrop-blur-xl">
        <div className="section-shell flex min-h-16 flex-wrap items-center justify-between gap-4 py-3">
          <div>
            <p className="text-sm uppercase tracking-[0.18em] text-cyan-200">Agency reports</p>
            <h1 className="mt-1 text-2xl font-semibold text-white">Client Reporting</h1>
          </div>
      ...
      <div className="border-b border-white/5 bg-[#070b12]/50">
        <div className="section-shell flex gap-6">
          ...
          <a href="/dashboard/reports" className="border-b-2 border-cyan-400 py-3 text-sm font-medium text-white">Reports</a>
      ...
      <section className="section-shell py-8">
        <ReportsManager initialReports={existingReports} sites={orgSites} />
      </section>
    </main>
  );
}
